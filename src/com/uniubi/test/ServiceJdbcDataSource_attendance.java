...
public class ServiceJdbcDataSource_attendance {

	private ComboPooledDataSource pool;
	private static ServiceJdbcDataSource_attendance instance_attendance;
	
	public static final ServiceJdbcDataSource_attendance getInstance(){
		if (instance_attendance == null) {
		 	try {
		 		instance_attendance = new ServiceJdbcDataSource_attendance();
		 	} catch (Exception e) {
		 		e.printStackTrace();
		 	}
		}
	...
	public ServiceJdbcDataSource_attendance(){
		int poolSize = 1;
    	String driverName = "com.mysql.jdbc.Driver";
    	String url = "jdbc:mysql://192.168.1.37:3307/smartstage_attendance?useUnicode=true&characterEncoding=utf-8&&zeroDateTimeBehavior=convertToNull";
	...
	public void release_attendance(Connection connection){
		try {
			connection.close();
