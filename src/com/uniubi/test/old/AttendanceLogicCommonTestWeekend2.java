...
import com.uniubi.common.oldlogic.weekend.AttendanceLogicCommonTest2AssertBaseWeekend;
...
//		suite.addTest(new AttendanceLogicCommonTestWeekend2("Test4_4"));
	...
	public void Testx_x_1() throws Exception {
		...
		AttendanceLogicCommonTest2AssertBaseWeekend.getInstance( A1, B1, A2, B2, t1_1, t1_n, t2_1, t2_n, e1, f1, e2, f2,employeeDay,employeeNextDay,caseNo).Testx_x_1_1();
		employeeDay = dao.getEmployeeDay(userId,employeeId,day,2); 
		AttendanceLogicCommonTest2AssertBaseWeekend.getInstance( A1, B1, A2, B2, t1_1, t1_n, t2_1, t2_n, e1, f1, e2, f2,employeeDay,employeeNextDay,caseNo).Testx_x_1_1();
		//插入第二天打卡记录
		attendancesCreate2(2);
		
	
		//校验第二天,工时、请假时间
		employeeNextDay = dao.getEmployeeDay(userId,employeeId,nextday,1); 
//		System.out.println(JsonUtil.toString(employeeNextDay));
		AttendanceLogicCommonTest2AssertBaseWeekend.getInstance( A1, B1, A2, B2, t1_1, t1_n, t2_1, t2_n, e1, f1, e2, f2,employeeDay,employeeNextDay,caseNo).Testx_x_1_2();
...
//		System.out.println(JsonUtil.toString(employeeNextDay));
		...
		if(e2 != null && f2 != null){
			...
			AttendanceLogicCommonTest2AssertBaseWeekend.getInstance( A1, B1, A2, B2, t1_1, t1_n, t2_1, t2_n, e1, f1, e2, f2,employeeDay,employeeNextDay,caseNo).Testx_x_1_3();
	...
	public void Testx_x_2() throws Exception {
		...
		//校验第二天,工时、请假时间
		employeeNextDay = dao.getEmployeeDayall(userId,employeeId,nextday,1); 
		AttendanceLogicCommonTest2AssertBaseWeekend.getInstance( A1, B1, A2, B2, t1_1, t1_n, t2_1, t2_n, e1, f1, e2, f2,employeeDay,employeeNextDay,caseNo).Testx_x_2_1();
		...
		employeeNextDay = dao.getEmployeeDay(userId,employeeId,nextday,1); 
//		System.out.println(JsonUtil.toString(employeeNextDay));
		AttendanceLogicCommonTest2AssertBaseWeekend.getInstance( A1, B1, A2, B2, t1_1, t1_n, t2_1, t2_n, e1, f1, e2, f2,employeeDay,employeeNextDay,caseNo).Testx_x_2_2();
...
//		System.out.println(JsonUtil.toString(employeeNextDay));
		...
		if(e2 != null && f2 != null){
			...
			//校验第二天,工时、请假时间
			employeeNextDay = dao.getEmployeeDayall(userId,employeeId,nextday,1); 
			AttendanceLogicCommonTest2AssertBaseWeekend.getInstance( A1, B1, A2, B2, t1_1, t1_n, t2_1, t2_n, e1, f1, e2, f2,employeeDay,employeeNextDay,caseNo).Testx_x_2_3();
			employeeDay = dao.getEmployeeDay(userId,employeeId,day,2); 
			//校验第二天,工时、请假时间
			employeeNextDay = dao.getEmployeeDayall(userId,employeeId,nextday,2); 
			AttendanceLogicCommonTest2AssertBaseWeekend.getInstance( A1, B1, A2, B2, t1_1, t1_n, t2_1, t2_n, e1, f1, e2, f2,employeeDay,employeeNextDay,caseNo).Testx_x_2_3();
...
//		System.out.println(JsonUtil.toString(employeeDay));
		...
		employeeNextDay = dao.getEmployeeDayall(userId,employeeId,nextday,1); 
//		System.out.println(JsonUtil.toString(employeeNextDay));
		AttendanceLogicCommonTest2AssertBaseWeekend.getInstance( A1, B1, A2, B2, t1_1, t1_n, t2_1, t2_n, e1, f1, e2, f2,employeeDay,employeeNextDay,caseNo).Testx_x_3_1();
...
//			System.out.println(JsonUtil.toString(employeeDay));
			...
			employeeNextDay = dao.getEmployeeDayall(userId,employeeId,nextday,1); 
//			System.out.println(JsonUtil.toString(employeeNextDay));
			AttendanceLogicCommonTest2AssertBaseWeekend.getInstance( A1, B1, A2, B2, t1_1, t1_n, t2_1, t2_n, e1, f1, e2, f2,employeeDay,employeeNextDay,caseNo).Testx_x_3_2();
		}
