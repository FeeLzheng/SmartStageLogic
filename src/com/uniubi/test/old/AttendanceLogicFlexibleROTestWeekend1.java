...
import com.uniubi.flexible.oldlogic.weekend.AttendanceLogicFlexibleROTest1AssertBaseWeekend;
 ...
 * 2016-06-06
 */
public class AttendanceLogicFlexibleROTestWeekend1 extends OldBaseTestCaseWeekend{

	
	private static byte type1=8;//流程类别。1-病假;2-事假;3-产假;4-年假;8-特殊假;5-补签;6-出差;7-其他;
	...
	public AttendanceLogicFlexibleROTestWeekend1(String name){
		super(name);
		try {
...
//		suite.addTest(new AttendanceLogicFlexibleROTestWeekend1("Test4_1"));
	...
	public void Testx_x_1() throws Exception {
		...
		AttendanceLogicFlexibleROTest1AssertBaseWeekend.getInstance( A1, B1, t1_1, t1_n, e1, f1, e2, f2,r1_1,r1_2,r2_1,r2_2,employeeDay,caseNo).Testx_x(1);
...
//			System.out.println(JsonUtil.toString(employeeDay));
			AttendanceLogicFlexibleROTest1AssertBaseWeekend.getInstance( A1, B1, t1_1, t1_n, e1, f1, e2, f2,r1_1,r1_2,r2_1,r2_2,employeeDay,caseNo).Testx_x(2);
...
//		System.out.println(JsonUtil.toString(employeeDay));
		...
		if((e2 != null && f2 != null) || (r2_1 != null) || (o2_1 != null && o2_2 != null)){
			//更新第二个流程
			dao.ProcedureCreate(e2,f2,procedureId2,employeeId,type1);
			//更新第一天补充发起的补签流程1
			dao.RepairCreate(r2_1,repairProcedureId1r_1,employeeId);
			//更新第一天补充发起的补签流程2
			dao.RepairCreate(r2_2,repairProcedureId1r_1,employeeId);
