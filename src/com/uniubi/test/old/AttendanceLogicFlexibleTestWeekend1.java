...
import com.uniubi.flexible.oldlogic.weekend.AttendanceLogicFlexibleTest1AssertBaseWeekend;
 ...
 * 2016-05-31
 */
public class AttendanceLogicFlexibleTestWeekend1 extends OldBaseTestCaseWeekend{
	...
	public AttendanceLogicFlexibleTestWeekend1(String name){
		super(name);
		try {
...
//		System.out.println(JsonUtil.toString(employeeDay));
		AttendanceLogicFlexibleTest1AssertBaseWeekend.getInstance( A1, B1, t1_1, t1_n, e1, f1, e2, f2,employeeDay,caseNo).Testx_x(1);
...
//				System.out.println(JsonUtil.toString(employeeDay));
		...
		if(e2 != null && f2 != null){
			...
			employeeDay = dao.getEmployeeDay(userId,employeeId,day,1); 
//			System.out.println(JsonUtil.toString(employeeDay));
			AttendanceLogicFlexibleTest1AssertBaseWeekend.getInstance( A1, B1, t1_1, t1_n, e1, f1, e2, f2,employeeDay,caseNo).Testx_x(2);
			employeeDay = dao.getEmployeeDay(userId,employeeId,day,2); 
//			System.out.println(JsonUtil.toString(employeeDay));
			AttendanceLogicFlexibleTest1AssertBaseWeekend.getInstance( A1, B1, t1_1, t1_n, e1, f1, e2, f2,employeeDay,caseNo).Testx_x(2);
		}
