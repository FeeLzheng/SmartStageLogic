...
import com.uniubi.flexible.oldlogic.weekend.AttendanceLogicFlexibleTest2AssertBaseWeekend;
 ...
 * 2016-05-28
 */
public class AttendanceLogicFlexibleTestWeekend2 extends OldBaseTestCaseWeekend{
	...
	public AttendanceLogicFlexibleTestWeekend2(String name){
		super(name);
		try {
...
////	
	...
	public void Testx_x_1() throws Exception {
		...
		if(employeeDay!=null){
		AttendanceLogicFlexibleTest2AssertBaseWeekend.getInstance( A1, B1, A2, B2, t1_1, t1_n, t2_1, t2_n, e1, f1, e2, f2,employeeDay,employeeNextDay,caseNo).Testx_x_1_1();
		...
		if(employeeNextDay!=null){
		AttendanceLogicFlexibleTest2AssertBaseWeekend.getInstance( A1, B1, A2, B2, t1_1, t1_n, t2_1, t2_n, e1, f1, e2, f2,employeeDay,employeeNextDay,caseNo).Testx_x_1_2();
		...
		if(e2 != null && f2 != null){
			...
			if(employeeDay!=null){
			AttendanceLogicFlexibleTest2AssertBaseWeekend.getInstance( A1, B1, A2, B2, t1_1, t1_n, t2_1, t2_n, e1, f1, e2, f2,employeeDay,employeeNextDay,caseNo).Testx_x_1_3();
	...
	public void Testx_x_2() throws Exception {
		...
		AttendanceLogicFlexibleTest2AssertBaseWeekend.getInstance( A1, B1, A2, B2, t1_1, t1_n, t2_1, t2_n, e1, f1, e2, f2,employeeDay,employeeNextDay,caseNo).Testx_x_2_1();
		...
		employeeNextDay = dao.getEmployeeDay(userId,employeeId,nextday,1);
		if(employeeNextDay!=null){
		AttendanceLogicFlexibleTest2AssertBaseWeekend.getInstance( A1, B1, A2, B2, t1_1, t1_n, t2_1, t2_n, e1, f1, e2, f2,employeeDay,employeeNextDay,caseNo).Testx_x_2_2();
		...
		if(e2 != null && f2 != null){
			...
			if(employeeDay!=null){
			AttendanceLogicFlexibleTest2AssertBaseWeekend.getInstance( A1, B1, A2, B2, t1_1, t1_n, t2_1, t2_n, e1, f1, e2, f2,employeeDay,employeeNextDay,caseNo).Testx_x_2_3();
	...
	public void Testx_x_3() throws Exception {
		...
		if(employeeDay!=null){
		AttendanceLogicFlexibleTest2AssertBaseWeekend.getInstance( A1, B1, A2, B2, t1_1, t1_n, t2_1, t2_n, e1, f1, e2, f2,employeeDay,employeeNextDay,caseNo).Testx_x_3_1();
		...
		if(e2 != null && f2 != null){
			...
			//校验第二天,工时、请假时间
			employeeNextDay = dao.getEmployeeDayall(userId,employeeId,nextday,1); 
			AttendanceLogicFlexibleTest2AssertBaseWeekend.getInstance( A1, B1, A2, B2, t1_1, t1_n, t2_1, t2_n, e1, f1, e2, f2,employeeDay,employeeNextDay,caseNo).Testx_x_3_2();
