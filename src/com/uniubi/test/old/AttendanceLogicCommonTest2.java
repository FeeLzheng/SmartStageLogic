...
import com.uniubi.common.oldlogic.AttendanceLogicCommonTest2AssertBase;
...
////	
	...
	public void Testx_x_1() throws Exception {
		System.out.println("运行Testx_x_1");
		//插入第一天打卡记录
...
//		System.out.println(JsonUtil.toString(employeeNextDay));
	...
	public void Testx_x_2() throws Exception {
		System.out.println("运行Testx_x_2");
		//插入第一天打卡记录
		attendancesCreate(1);
...
//		System.out.println(JsonUtil.toString(employeeNextDay));
	...
	public void Testx_x_3() throws Exception {
		System.out.println("运行Testx_x_3");
		//插入第一天打卡记录
		attendancesCreate(1);
