...
public class ServiceJdbcDataSource {

	private ComboPooledDataSource pool;
	private static ServiceJdbcDataSource instance;
	
	public static final ServiceJdbcDataSource getInstance(){
		if (instance == null) {
		 	try {
		 		instance = new ServiceJdbcDataSource();
		 	} catch (Exception e) {
		 		e.printStackTrace();
		 	}
		}
	...
	public ServiceJdbcDataSource(){
		int poolSize = 1;
    	String driverName = "com.mysql.jdbc.Driver";
    	String url = "jdbc:mysql://192.168.1.37:3307/smartstage?useUnicode=true&characterEncoding=utf-8&&zeroDateTimeBehavior=convertToNull";
