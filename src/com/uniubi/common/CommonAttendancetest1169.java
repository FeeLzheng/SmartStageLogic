...
public class CommonAttendancetest1169 extends AttendanceBase{
	...
	public void test1(){
		...
		assertEquals(employeeday1.getLeaveDur(),convserToMinutes(B1_1.getTime()-t1_2.getTime()+B1_2.getTime()-t1_4.getTime()+B1_3.getTime()-t1_5.getTime()));
	...
	public void test4(){
		...
		assertEquals(employeeday4.getLeaveDur(),convserToMinutes(B1_3.getTime()-t1_5.getTime()));
