...
public class CommonAttendancetest1176 extends AttendanceBase{
	...
	public void test1(){
		...
		assertEquals(employeeday1.getDelayDur(),convserToMinutes(B1_2.getTime()-A1_2.getTime()+t1_2.getTime()-A1_1.getTime()));
		assertEquals(employeeday1.getLeaveEarly(),2);
		assertEquals(employeeday1.getLeaveDur(),convserToMinutes(B1_3.getTime()-A1_3.getTime()));
	...
	public void test4(){
		...
		assertEquals(employeeday4.getLeaveDur(),convserToMinutes(B1_3.getTime()-A1_3.getTime()));
