...
public class CommonAttendancetest148 extends AttendanceBase{
	...
	public void test1(){
		...
		assertEquals(employeeday1.getDelayDur(),convserToMinutes(t1_5.getTime()-A1_3.getTime()+t1_2.getTime()-A1_1.getTime()+t1_3.getTime()-A1_2.getTime()));
