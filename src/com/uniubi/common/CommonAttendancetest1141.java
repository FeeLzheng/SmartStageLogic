...
public class CommonAttendancetest1141 extends AttendanceBase{
	...
	public void test1(){
		...
		assertEquals(employeeday1.getDelayDur(),convserToMinutes(t1_3.getTime()-A1_2.getTime()+t1_1.getTime()-A1_1.getTime()));
