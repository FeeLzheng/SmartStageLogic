...
public class CommonAttendancetest129 extends AttendanceBase{
	...
	public void test1(){
		...
		assertEquals(employeeday1.getDelayDur(),convserToMinutes(t1_5.getTime()-A1_3.getTime()+B1_2.getTime()-A1_2.getTime()));
	...
	public void test4(){
		...
		assertEquals(employeeday4.getDelayDur(),1);
