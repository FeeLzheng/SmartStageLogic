...
public class CommonAttendancetest1148 extends AttendanceBase{
	...
	public void test1(){
		...
		assertEquals(employeeday1.getDelayDur(),convserToMinutes(t1_3.getTime()-A1_2.getTime()+t1_5.getTime()-A1_3.getTime()+t1_2.getTime()-A1_1.getTime()));
		assertEquals(employeeday1.getLeaveEarly(),2);
		assertEquals(employeeday1.getLeaveDur(),convserToMinutes(B1_2.getTime()-t1_4.getTime()+B1_3.getTime()-t1_6.getTime()+B1_1.getTime()-t1_2.getTime()));
	...
	public void test2(){
		...
		assertEquals(employeeday2.getDelayDur(),convserToMinutes(t1_2.getTime()-A1_1.getTime()));
	...
	public void test4(){
		...
		assertEquals(employeeday4.getDelayDur(),convserToMinutes(t1_5.getTime()-A1_3.getTime()));
