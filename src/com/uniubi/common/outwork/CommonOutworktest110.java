...
public class CommonOutworktest110 extends OutworkBase{
	...
	public void test1_1(){
		...
		assertEquals(employeeday1.getWorkDur(),convserToMinutes(o1_2.getTime()-o1_1.getTime()-A1_2.getTime()+B1_1.getTime()));
	...
	public void test1(){
		...
		assertEquals(employeeday1.getLeaveDur(),0);
		assertEquals(employeeday1.getWorkShow(),2);
		assertEquals(employeeday1.getWorkDur(),convserToMinutes(B1_1.getTime()-A1_1.getTime()+B1_2.getTime()-A1_2.getTime()));
		assertEquals(employeeday1.getAllLeaveDur(),0);
		assertEquals(employeeday1.getNoShow(),1);
		assertEquals(employeeday1.getOutWork(),2);
		assertEquals(employeeday1.getTpye(),1);
