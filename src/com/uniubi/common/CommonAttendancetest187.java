...
public class CommonAttendancetest187 extends AttendanceBase{
	...
	public void test1(){
		...
		assertEquals(employeeday1.getLeaveDur(),convserToMinutes(B1_1.getTime()-t1_2.getTime()+B1_3.getTime()-t1_6.getTime()));
