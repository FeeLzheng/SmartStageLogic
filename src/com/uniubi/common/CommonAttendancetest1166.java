...
public class CommonAttendancetest1166 extends AttendanceBase{
	...
	public void test1(){
		...
		assertEquals(employeeday1.getDelayDur(),convserToMinutes(t1_1.getTime()-A1_1.getTime()+t1_3.getTime()-A1_2.getTime()+t1_6.getTime()-A1_3.getTime()));
	...
	public void test4(){
		...
		assertEquals(employeeday4.getDelayDur(),convserToMinutes(t1_6.getTime()-A1_3.getTime()));
