...
public class AttendanceLogicCommonTest2Assert24 extends AttendanceLogicCommonTest2AssertBase {
	...
	public void Textx_x_last() {
		assertEquals(employeeDay.getDelayDur(),convertMsToMinutes(t1_1.getTime()-A1.getTime()+e2.getTime()-f2.getTime()));//Failed TODO
		assertEquals(employeeDay.getLeaveDur(),0);
		assertEquals(employeeDay.getAllLeaveDur(),convertMsToMinutes(B1.getTime()-e1.getTime()+f2.getTime()-e2.getTime()));//Failed TODO
