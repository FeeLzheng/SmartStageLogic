...
public class AttendanceLogicCommonTest2Assert16 extends AttendanceLogicCommonTest2AssertBase {

	@Override
	public void Testx_x_1_all() {
		assertEquals(employeeDay.getWorkDur(),convertMsToMinutes(t1_1.getTime()-t1_1.getTime()));
	...
	public void Testx_x_2_all() {
		assertEquals(employeeNextDay.getWorkDur(),convertMsToMinutes(t2_1.getTime()-t2_1.getTime()));
	...
	public void Textx_x_last() {
		...
		assertEquals(employeeNextDay.getDelayDur(),0);
		assertEquals(employeeNextDay.getLeaveDur(),convertMsToMinutes(e2.getTime()-f1.getTime() + B2.getTime() - f2.getTime()));
