...
public class AttendanceLogicCommonROTest1AssertWeekend15 extends
		AttendanceLogicCommonROTest1AssertBaseWeekend {

	@Override
	public void Testx_x_1() {
	//	System.out.println(employeeDay.getWorkDur());
	//	System.out.println(convertMsToMinutes((B1.getTime()-A1.getTime())));
	...
	public void Testx_x_2() {
		assertEquals(employeeDay.getWorkDur(),convertMsToMinutes(0));
		assertEquals(employeeDay.getDelayDur(),0);
		assertEquals(employeeDay.getLeaveDur(),0);
