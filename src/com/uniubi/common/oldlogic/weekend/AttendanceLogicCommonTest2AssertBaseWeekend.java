...
public abstract class AttendanceLogicCommonTest2AssertBaseWeekend {
	...
	//第二个请假结束时间
	 ...
	 static AttendanceLogicCommonTest2AssertBaseWeekend instance;
	
	public AttendanceLogicCommonTest2AssertBaseWeekend(){
		
	}
	
	@SuppressWarnings("deprecation")
	public static AttendanceLogicCommonTest2AssertBaseWeekend getInstance(Date A1,Date B1,Date A2,Date B2,Date t1_1,Date t1_n,Date t2_1,Date t2_n,Date e1,Date f1,Date e2,Date f2,EmployeeDay employeeDay,EmployeeDay employeeNextDay,String caseNo){
		try {
			Class<AttendanceLogicCommonTest2AssertBaseWeekend> clazz = (Class<AttendanceLogicCommonTest2AssertBaseWeekend>) Class.forName("com.uniubi.common.oldlogic.weekend.AttendanceLogicCommonTest2AssertWeekend"+caseNo);
