...
//		System.out.println(JsonUtil.toString(employeeDay));
		...
		if(e2 != null && f2 != null){
			...
			employeeDay2 = dao.getEmployeeDay(userId,employeeId,day,2);
//			System.out.println(JsonUtil.toString(employeeDay));
			AttendanceLogicCommonTest1AssertBase.getInstance( A1, B1, t1_1, t1_n, e1, f1, e2, f2,employeeDay,caseNo).Testx_x(2);
			AttendanceLogicCommonTest1AssertBase.getInstance( A1, B1, t1_1, t1_n, e1, f1, e2, f2,employeeDay2,caseNo).Testx_x(2);
		}
