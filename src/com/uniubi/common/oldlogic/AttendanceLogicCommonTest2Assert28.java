...
public class AttendanceLogicCommonTest2Assert28 extends AttendanceLogicCommonTest2AssertBase {
	...
	public void Testx_x_2_all() {
		...
		assertEquals(employeeNextDay.getLeaveDur(),convertMsToMinutes(B2.getTime()-f1.getTime()));//Failed TODO
