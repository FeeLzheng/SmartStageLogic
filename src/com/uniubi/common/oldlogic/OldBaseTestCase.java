...
public abstract class OldBaseTestCase extends TestCase {
	 ...
	 static final String dayStr = "2018-07-02";//工作日
	 static final String nextDayStr = "2018-07-03";//工作日
	 static final String next2DayStr = "2018-07-04";//工作日
	 static final String AStr = "10:00:00";
	 static final String BStr = "20:00:00";
	 static final String STARTStr = "04:00:00";
	 static final String ENDStr = "03:59:00";
	 static final String DLStr = "18:00:00";//要上满工时，最晚打卡时间  deadline
	...
	//第二个请假结束时间
	 ...
	 static EmployeeDay employeeNextDay2;
	
	
	
	public OldBaseTestCase(String name){
		super(name);
		userId = 52;
		procedureId1 = 23;
		procedureId2 = 24;
	...
	public abstract void Testx_x_4() throws Exception;//出差跨天
	public abstract void Testx_x_5() throws Exception;//出差跨天
	public abstract void Testx_x_6() throws Exception;//出差跨天
	
	//插入打卡记录
	void attendancesCreate(int dayNo)
		throws ParseException {
		if(dayNo == 1){
			if(t1_1 != null || t1_n != null)
				dao.AttendanceCreate(userId,employeeId,t1_1,t1_n);
		}else if (dayNo == 2){
			if(t2_1 != null || t1_n != null) 
				dao.AttendanceCreate(userId,employeeId,t1_1,t1_n);
		}
	}
