...
public class AttendanceLogicCommonTest2Assert15 extends AttendanceLogicCommonTest2AssertBase {
	...
	public void Textx_x_last() {
		assertEquals(employeeDay.getDelayDur(),0);
		assertEquals(employeeDay.getLeaveDur(),convertMsToMinutes(e1.getTime()-f2.getTime()+e2.getTime()-A1.getTime()));
