...
public class AttendanceLogicCommonTest1Assert25 extends AttendanceLogicCommonTest1AssertBase {
	...
	public void Testx_x_2() {
		assertEquals(employeeDay.getWorkDur(),convertMsToMinutes((tn.getTime()-t1.getTime())));
		assertEquals(employeeDay.getDelayDur(),convertMsToMinutes((e1.getTime()-A1.getTime())));
		assertEquals(employeeDay.getLeaveDur(),convertMsToMinutes(B1.getTime()-f2.getTime() + e2.getTime() - tn.getTime()));
		assertEquals(employeeDay.getNoShow(),1);
		assertEquals(employeeDay.getWorkShow(),2);
		assertEquals(employeeDay.getOutWork(),1);
	}
