...
public class AttendanceLogicCommonROTest1 extends OldBaseTestCase{
	...
	private static Date o3_1;//第二天天已发起的出差流程开始时间
	private static Date o3_2;//第二天已发起的出差流程结束时间
...
//	private static int leaveProcedureId2 =  1189;
	...
	public AttendanceLogicCommonROTest1(String name){
		super(name);
		try {
...
//		
	...
	public void Testx_x_1() throws Exception {
		...
		AttendanceLogicCommonROTest1AssertBase.getInstance( A1, B1, t1_1, t1_n, e1, f1, e2, f2,r1_1,r1_2,r2_1,r2_2,employeeDay2,employeeNextDay2,caseNo).Testx_x(1);
		if((e2 != null && f2 != null) || (r2_1 != null) || (o2_1 != null && o2_2 != null)){
			...
			employeeDay2 = dao.getEmployeeDay(userId,employeeId,day,2); 
			employeeNextDay2 = dao.getEmployeeDay(userId,employeeId,nextday,2); 
			AttendanceLogicCommonROTest1AssertBase.getInstance( A1, B1, t1_1, t1_n, e1, f1, e2, f2,r1_1,r1_2,r2_1,r2_2,employeeDay,employeeNextDay,caseNo).Testx_x(2);
			AttendanceLogicCommonROTest1AssertBase.getInstance( A1, B1, t1_1, t1_n, e1, f1, e2, f2,r1_1,r1_2,r2_1,r2_2,employeeDay2,employeeNextDay2,caseNo).Testx_x(2);
		}
...
//			System.out.println(JsonUtil.toString(employeeDay));
		...
		public void Testx_x_6() throws Exception {
			...
			//dao.updateProcedure(o3_1,o3_2,outworkProcedureId);
