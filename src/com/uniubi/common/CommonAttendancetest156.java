...
public class CommonAttendancetest156 extends AttendanceBase{
	...
	public void test1(){
		...
		assertEquals(employeeday1.getLeaveDur(),convserToMinutes(B1_1.getTime()-t1_2.getTime()+B1_2.getTime()-t1_4.getTime()+B1_3.getTime()-A1_3.getTime()));
