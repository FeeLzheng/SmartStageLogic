...
public class CommonAttendancetest18 extends AttendanceBase{
	...
	public void test1(){
		...
		assertEquals(employeeday1.getDelayDur(),convserToMinutes(t1_1.getTime()-A1_1.getTime()+B1_2.getTime()-A1_2.getTime()));
