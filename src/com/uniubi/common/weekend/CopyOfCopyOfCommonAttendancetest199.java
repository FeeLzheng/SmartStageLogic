...
public class CopyOfCopyOfCommonAttendancetest199 extends AttendanceBase{
	...
	public void test1(){
		...
		assertEquals(employeeday1.getLeaveDur(),convserToMinutes(B1_2.getTime()-t1_4.getTime()+B1_3.getTime()-t1_6.getTime()));
	...
	public void test2(){
		...
		assertEquals(employeeday2.getTpye(),1);
	...
	public void test3(){
		...
		assertEquals(employeeday3.getTpye(),1);
	...
	public void test4(){
		...
		assertEquals(employeeday4.getDelayDur(),2);
		...
		assertEquals(employeeday4.getTpye(),1);
