...
public class CommonRepairtest112 extends RepairBase{
	...
	public void test1_1(){
		...
		assertEquals(employeeday1.getDelayDur(),convserToMinutes(B1_2.getTime()-A1_2.getTime()+B1_3.getTime()-A1_3.getTime()));
		assertEquals(employeeday1.getLeaveEarly(),2);
		assertEquals(employeeday1.getLeaveDur(),convserToMinutes(B1_1.getTime()-t1_1.getTime()));
	...
	public void test2_1(){
		...
		assertEquals(employeeday2.getLeaveDur(),convserToMinutes(B1_1.getTime()-t1_1.getTime()));
	...
	public void test3_1(){
		...
		assertEquals(employeeday3.getDelayDur(),convserToMinutes(B1_2.getTime()-A1_2.getTime()));
	...
	public void test4_1(){
		...
		assertEquals(employeeday4.getDelayDur(),convserToMinutes(B1_3.getTime()-A1_3.getTime()));
	...
	public void test1(){
		...
		assertEquals(employeeday1.getWorkShow(),2);
		assertEquals(employeeday1.getWorkDur(),convserToMinutes(r1_2.getTime()-r1_1.getTime()+t1_4.getTime()-r1_2.getTime()+t1_6.getTime()-r1_3.getTime()));
		assertEquals(employeeday1.getAllLeaveDur(),0);
		assertEquals(employeeday1.getNoShow(),1);
		assertEquals(employeeday1.getOutWork(),1);
		assertEquals(employeeday1.getTpye(),1);
	...
	public void test3(){
		...
		assertEquals(employeeday3.getLeaveDur(),0);
		assertEquals(employeeday3.getWorkShow(),2);
		assertEquals(employeeday3.getWorkDur(),convserToMinutes(t1_4.getTime()-r1_2.getTime()));
		assertEquals(employeeday3.getAllLeaveDur(),0);
		assertEquals(employeeday3.getNoShow(),1);
		assertEquals(employeeday3.getOutWork(),1);
		assertEquals(employeeday3.getTpye(),3);
	...
	public void test4(){
		...
		assertEquals(employeeday4.getLeaveDur(),0);
		assertEquals(employeeday4.getWorkShow(),2);
		assertEquals(employeeday4.getWorkDur(),convserToMinutes(t1_6.getTime()-r1_3.getTime()));
		assertEquals(employeeday4.getAllLeaveDur(),0);
		assertEquals(employeeday4.getNoShow(),1);
		assertEquals(employeeday4.getOutWork(),1);
		assertEquals(employeeday4.getTpye(),4);
