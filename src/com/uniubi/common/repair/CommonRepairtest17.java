...
public class CommonRepairtest17 extends RepairBase{
	...
	public void test1_1(){
		...
		assertEquals(employeeday1.getDelayDur(),convserToMinutes(B1_2.getTime()-A1_2.getTime()));
		assertEquals(employeeday1.getLeaveEarly(),2);
		assertEquals(employeeday1.getLeaveDur(),convserToMinutes(B1_1.getTime()-A1_1.getTime()));
	...
	public void test2_1(){
		...
		assertEquals(employeeday2.getLeaveDur(),convserToMinutes(B1_1.getTime()-A1_1.getTime()));
	...
	public void test1(){
		...
		assertEquals(employeeday1.getWorkShow(),2);
		assertEquals(employeeday1.getWorkDur(),convserToMinutes(r1_2.getTime()-r1_1.getTime()+t1_4.getTime()-r1_2.getTime()));
		assertEquals(employeeday1.getAllLeaveDur(),0);
		assertEquals(employeeday1.getNoShow(),1);
		assertEquals(employeeday1.getOutWork(),1);
		assertEquals(employeeday1.getTpye(),1);
