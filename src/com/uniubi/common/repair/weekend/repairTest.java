...
//	}
	...
	public void test1_15() throws Exception{
		...
		r1_1=repairTime("09:00:00",1);
		r1_2=repairTime("11:00:00",2);
		r1_3=repairTime("09:00:00",3);
		r1_4=repairTime("11:00:00",4);
	...
	public void Testx_x_1() throws Exception{
		...
		if(No==1){		
			...
			employeeDay1=dao.getEmployeeDayall(userId, employeeId, day, 1);//总记录
			employeeDay2=dao.getEmployeeDayall(userId, employeeId, day, 2);//分记录
	...
	public void Testx_x_2() throws Exception{
		...
		if(No==1){		
			...
			employeeDay1=dao.getEmployeeDayall(userId, employeeId, day, 1);//总记录
			employeeDay2=dao.getEmployeeDayall(userId, employeeId, day, 2);//分记录
			employeeDay3=dao.getEmployeeDayall(userId, employeeId, day, 3);//分记录
	...
	public void Testx_x_3() throws Exception{
		...
		attendanceCreate2(1);//先生成记录,一天三班}
		attendanceCreate2(2);//先生成记录,一天三班}
		attendanceCreate2(3);//先生成记录,一天三班}
		...
		if(No==1){
			...
			employeeDay2=dao.getEmployeeDayall(userId, employeeId, day, 2);//分记录
			employeeDay3=dao.getEmployeeDayall(userId, employeeId, day, 3);//分记录
			employeeDay4=dao.getEmployeeDayall(userId, employeeId, day, 4);//分记录
