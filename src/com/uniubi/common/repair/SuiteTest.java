...
//		suite.addTest(new repairTest("test1_9"));	
//		suite.addTest(new repairTest("test1_10"));
//		suite.addTest(new repairTest("test1_11"));
//		suite.addTest(new repairTest("test1_12"));
//		suite.addTest(new repairTest("test1_13"));	
//		suite.addTest(new repairTest("test1_14"));	
//		suite.addTest(new repairTest("test1_15"));
		return suite;
