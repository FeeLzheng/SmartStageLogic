...
public class CommonRepairtest115 extends RepairBase{
	...
	public void test1_1(){
		...
		assertEquals(employeeday1.getLeaveDur(),convserToMinutes(B1_1.getTime()-t1_2.getTime()+B1_2.getTime()-t1_4.getTime()+B1_3.getTime()-t1_6.getTime()));
	...
	public void test4(){
		...
		assertEquals(employeeday4.getWorkShow(),2);
		System.out.println(convserToMinutes(r1_6.getTime()-r1_5.getTime()));
