...
public class CommonAttendancetest1151 extends AttendanceBase{
	...
	public void test1(){
		...
		assertEquals(employeeday1.getDelayDur(),convserToMinutes(t1_5.getTime()-A1_3.getTime()+t1_2.getTime()-A1_1.getTime()));
		assertEquals(employeeday1.getLeaveEarly(),2);
		assertEquals(employeeday1.getLeaveDur(),convserToMinutes(B1_3.getTime()-t1_6.getTime()+B1_2.getTime()-t1_4.getTime()+B1_1.getTime()-t1_2.getTime()));
