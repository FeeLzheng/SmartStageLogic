...
public class CommonAttendancetest194 extends AttendanceBase{
	...
	public void test1(){
		...
		assertEquals(employeeday1.getLeaveDur(),convserToMinutes(t1_1.getTime()-A1_1.getTime()));
	...
	public void test2(){
		...
		assertEquals(employeeday2.getLeaveDur(),convserToMinutes(t1_1.getTime()-A1_1.getTime()));
