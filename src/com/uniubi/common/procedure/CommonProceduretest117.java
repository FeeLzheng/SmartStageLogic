...
public class CommonProceduretest117 extends ProcedureBase{
	...
	public void test1(){
		...
		assertEquals(employeeday1.getDelayDur(),convserToMinutes(e1_2.getTime()-A1_1.getTime()+e1_1.getTime()-f1_2.getTime()));
	...
	public void test2(){
		...
		assertEquals(employeeday2.getDelayDur(),convserToMinutes(e1_2.getTime()-A1_1.getTime()+e1_1.getTime()-f1_2.getTime()));
