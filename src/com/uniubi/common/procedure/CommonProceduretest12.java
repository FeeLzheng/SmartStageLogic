...
public class CommonProceduretest12 extends ProcedureBase{
	...
	public void test1(){
		...
		assertEquals(employeeday1.getDelayDur(),convserToMinutes(e1_1.getTime()-A1_1.getTime()));
	...
	public void test2(){
		...
		assertEquals(employeeday2.getDelayDur(),convserToMinutes(e1_1.getTime()-A1_1.getTime()));
