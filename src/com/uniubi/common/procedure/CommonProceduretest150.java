...
public class CommonProceduretest150 extends ProcedureBase{
	...
	public void test1(){
		...
		assertEquals(employeeday1.getDelayDur(),convserToMinutes(t1_5.getTime()-f1_2.getTime()));
	...
	public void test4(){
		...
		assertEquals(employeeday4.getDelayDur(),convserToMinutes(t1_5.getTime()-f1_2.getTime()));
