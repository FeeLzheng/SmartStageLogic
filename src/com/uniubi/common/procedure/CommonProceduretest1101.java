...
public class CommonProceduretest1101 extends ProcedureBase{
	...
	public void test1_1(){
		...
		assertEquals(employeeday1.getAllLeaveDur(),convserToMinutes(B1_1.getTime()-e1_1.getTime()+f1_1.getTime()-A1_3.getTime()+B1_2.getTime()-A1_2.getTime()+f1_3.getTime()-e1_3.getTime()+f1_2.getTime()-e1_2.getTime()));
	...
	public void test2_4(){
		...
		assertEquals(employeeday4.getAllLeaveDur(),convserToMinutes(f1_1.getTime()-A1_3.getTime()+f1_3.getTime()-e1_3.getTime()));
	...
	public void test1(){
		...
		assertEquals(employeeday1.getWorkDur(),convserToMinutes(t1_6.getTime()-t1_5.getTime()));
		assertEquals(employeeday1.getAllLeaveDur(),convserToMinutes(B1_1.getTime()-e1_1.getTime()+f1_1.getTime()-A1_3.getTime()+B1_2.getTime()-A1_2.getTime()+f1_2.getTime()-e1_2.getTime()+f1_3.getTime()-e1_3.getTime()));
		assertEquals(employeeday1.getNoShow(),1);
		assertEquals(employeeday1.getOutWork(),1);
		assertEquals(employeeday1.getTpye(),1);
	...
	public void test2(){
		...
		assertEquals(employeeday2.getWorkDur(),0);
		assertEquals(employeeday2.getAllLeaveDur(),convserToMinutes(B1_1.getTime()-e1_1.getTime()+f1_2.getTime()-e1_2.getTime()+f1_3.getTime()-e1_3.getTime()));
		assertEquals(employeeday2.getNoShow(),1);
		assertEquals(employeeday2.getOutWork(),1);
		assertEquals(employeeday2.getTpye(),2);
	...
	public void test4(){
		...
		assertEquals(employeeday4.getAllLeaveDur(),convserToMinutes(f1_1.getTime()-A1_3.getTime()));
		assertEquals(employeeday4.getNoShow(),1);
		assertEquals(employeeday4.getOutWork(),1);
		assertEquals(employeeday4.getTpye(),4);
