...
public class CommonProceduretest156 extends ProcedureBase{
	...
	public void test1(){
		...
		assertEquals(employeeday1.getDelayDur(),convserToMinutes(e1_3.getTime()-f1_2.getTime()));
	...
	public void test4(){
		...
		assertEquals(employeeday4.getDelayDur(),convserToMinutes(e1_3.getTime()-f1_2.getTime()));
		...
		assertEquals(employeeday4.getAllLeaveDur(),convserToMinutes(f1_1.getTime()-A1_3.getTime()+f1_2.getTime()-e1_2.getTime()+f1_3.getTime()-e1_3.getTime()));
