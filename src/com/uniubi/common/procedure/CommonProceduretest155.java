...
public class CommonProceduretest155 extends ProcedureBase{
	...
	public void test1(){
		...
		assertEquals(employeeday1.getLeaveDur(),convserToMinutes(e1_1.getTime()-t1_2.getTime()));
		assertEquals(employeeday1.getWorkShow(),2);
		assertEquals(employeeday1.getWorkDur(),convserToMinutes(t1_2.getTime()-t1_1.getTime()+t1_4.getTime()-t1_3.getTime()+t1_6.getTime()-t1_5.getTime()-(f1_1.getTime()-A1_3.getTime())-(f1_2.getTime()-e1_2.getTime())));
		assertEquals(employeeday1.getAllLeaveDur(),convserToMinutes(B1_1.getTime()-e1_1.getTime()+B1_2.getTime()-A1_2.getTime()+f1_1.getTime()-A1_3.getTime()+f1_2.getTime()-e1_2.getTime()));
	...
	public void test4(){
		...
		assertEquals(employeeday4.getWorkDur(),convserToMinutes(t1_6.getTime()-t1_5.getTime()-(f1_1.getTime()-A1_3.getTime())-(f1_2.getTime()-e1_2.getTime())));
