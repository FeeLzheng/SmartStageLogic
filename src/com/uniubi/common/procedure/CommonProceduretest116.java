...
public class CommonProceduretest116 extends ProcedureBase{
	...
	public void test1(){
		...
		assertEquals(employeeday1.getDelayDur(),convserToMinutes(t1_1.getTime()-f1_1.getTime()));
	...
	public void test2(){
		...
		assertEquals(employeeday2.getDelayDur(),convserToMinutes(t1_1.getTime()-f1_1.getTime()));
