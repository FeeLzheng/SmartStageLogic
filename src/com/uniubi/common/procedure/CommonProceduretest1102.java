...
public class CommonProceduretest1102 extends ProcedureBase{
	...
	public void test1(){
		...
		assertEquals(employeeday1_0.getAllLeaveDur(),330);
...
//		assertEquals(employeeday1_3.getTpye(),1);
		...
		assertEquals(employeeday1_4.getAllLeaveDur(),300);
	...
	public void test2(){
		...
		assertEquals(employeeday2_0.getAllLeaveDur(),90);
		assertEquals(employeeday2_0.getNoShow(),2);
...
//		
		...
		assertEquals(employeeday3_4.getAllLeaveDur(),180);
		assertEquals(employeeday3_4.getNoShow(),2);
