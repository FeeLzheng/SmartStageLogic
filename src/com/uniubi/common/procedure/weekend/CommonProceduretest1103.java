...
public class CommonProceduretest1103 extends ProcedureBase{
	...
	public void test1(){
		...
		assertEquals(employeeday2.getAllLeaveDur(),convserToMinutes(B1_1.getTime()-A1_1.getTime()+B1_2.getTime()-A1_2.getTime()));
		...
		assertEquals(employeeday2.getWorkShow(),1);
		assertEquals(employeeday2.getWorkDur(),0);
		assertEquals(employeeday2.getAllLeaveDur(),convserToMinutes(B1_1.getTime()-f1_1.getTime()+f1_2.getTime()-A1_2.getTime()));
		assertEquals(employeeday2.getNoShow(),1);
		assertEquals(employeeday2.getOutWork(),1);
		assertEquals(employeeday2.getTpye(),2);
	...
	public void test2(){
		...
		assertEquals(employeeday2.getWorkShow(),1);
		assertEquals(employeeday2.getWorkDur(),0);
		assertEquals(employeeday2.getAllLeaveDur(),convserToMinutes(B1_1.getTime()-f1_1.getTime()));
		assertEquals(employeeday2.getNoShow(),1);
		assertEquals(employeeday2.getOutWork(),1);
		assertEquals(employeeday2.getTpye(),2);
