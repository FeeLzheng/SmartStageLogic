...
public class CommonProceduretest186 extends ProcedureBase{
	...
	public void test1_1(){
		...
		assertEquals(employeeday1.getAllLeaveDur(),convserToMinutes(B1_1.getTime()-e1_1.getTime()+f1_1.getTime()-A1_2.getTime()+f1_2.getTime()-e1_2.getTime()));
	...
	public void test2_3(){
		...
		assertEquals(employeeday3.getAllLeaveDur(),convserToMinutes(f1_1.getTime()-A1_2.getTime()+f1_2.getTime()-e1_2.getTime()));
	...
	public void test1(){
		...
		assertEquals(employeeday1.getDelayDur(),convserToMinutes(t1_1.getTime()-A1_1.getTime()+t1_3.getTime()-f1_2.getTime()));
		assertEquals(employeeday1.getLeaveEarly(),2);
		assertEquals(employeeday1.getLeaveDur(),convserToMinutes(B1_2.getTime()-t1_4.getTime()+e1_1.getTime()-t1_2.getTime()));
	...
	public void test3(){
		...
		assertEquals(employeeday3.getDelayDur(),convserToMinutes(t1_3.getTime()-f1_2.getTime()));
