...
public class CommonProceduretest183 extends ProcedureBase{
	...
	public void test1_1(){
		...
		assertEquals(employeeday1.getAllLeaveDur(),convserToMinutes(B1_1.getTime()-e1_1.getTime()+f1_1.getTime()-A1_2.getTime()));
	...
	public void test2_3(){
		...
		assertEquals(employeeday3.getAllLeaveDur(),convserToMinutes(f1_1.getTime()-A1_2.getTime()));
	...
	public void test1(){
		...
		assertEquals(employeeday1.getDelayDur(),convserToMinutes(t1_1.getTime()-A1_1.getTime()+t1_3.getTime()-f1_1.getTime()));
	...
	public void test3(){
		...
		assertEquals(employeeday3.getDelayDur(),convserToMinutes(t1_3.getTime()-f1_1.getTime()));
