...
public class CommonProceduretest192 extends ProcedureBase{
	...
	public void test1_1(){
		...
		assertEquals(employeeday1.getAllLeaveDur(),convserToMinutes(B1_1.getTime()-e1_1.getTime()+f1_1.getTime()-A1_3.getTime()+B1_2.getTime()-A1_2.getTime()));
	...
	public void test1(){
		...
		assertEquals(employeeday1.getDelayDur(),convserToMinutes(t1_1.getTime()-A1_1.getTime()+t1_5.getTime()-f1_1.getTime()));
		assertEquals(employeeday1.getLeaveEarly(),2);
		assertEquals(employeeday1.getLeaveDur(),convserToMinutes(B1_3.getTime()-t1_6.getTime()+e1_1.getTime()-t1_2.getTime()));
	...
	public void test2(){
		...
		assertEquals(employeeday2.getLeaveDur(),convserToMinutes(e1_1.getTime()-t1_2.getTime()));
	...
	public void test4(){
		assertEquals(employeeday4.getUserid(),userId);
		assertEquals(employeeday4.getEmployeeid(),employeeId);
		assertEquals(employeeday4.getDelay(),2);
		assertEquals(employeeday4.getDelayDur(),convserToMinutes(t1_5.getTime()-f1_1.getTime()));
		assertEquals(employeeday4.getLeaveEarly(),2);
		assertEquals(employeeday4.getLeaveDur(),convserToMinutes(B1_3.getTime()-t1_6.getTime()));
