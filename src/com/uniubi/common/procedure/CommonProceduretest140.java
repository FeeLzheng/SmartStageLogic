...
public class CommonProceduretest140 extends ProcedureBase{
	...
	public void test1(){
		...
		assertEquals(employeeday1.getAllLeaveDur(),convserToMinutes(B1_1.getTime()-e1_1.getTime()+B1_2.getTime()-A1_2.getTime()+B1_3.getTime()-A1_3.getTime()));
	...
	public void test4(){
		...
		assertEquals(employeeday4.getAllLeaveDur(),convserToMinutes(B1_3.getTime()-A1_3.getTime()));
