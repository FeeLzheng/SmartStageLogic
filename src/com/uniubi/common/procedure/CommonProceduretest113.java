...
public class CommonProceduretest113 extends ProcedureBase{
	...
	public void test1(){
		...
		assertEquals(employeeday1.getLeaveDur(),convserToMinutes(B1_1.getTime()-f1_1.getTime()));
	...
	public void test2(){
		...
		assertEquals(employeeday2.getLeaveDur(),convserToMinutes(B1_1.getTime()-f1_1.getTime()));
