...
public class CommonProceduretest158 extends ProcedureBase{
	...
	public void test1(){
		...
		assertEquals(employeeday1.getWorkDur(),convserToMinutes(t1_2.getTime()-t1_1.getTime()+t1_4.getTime()-t1_3.getTime()+t1_6.getTime()-t1_5.getTime()-(B1_2.getTime()-A1_2.getTime())));
		assertEquals(employeeday1.getAllLeaveDur(),convserToMinutes(B1_1.getTime()-e1_1.getTime()+B1_2.getTime()-A1_2.getTime()+f1_1.getTime()-A1_3.getTime()+f1_2.getTime()-e1_2.getTime()+f1_3.getTime()-e1_3.getTime()));
	...
	public void test2(){
		...
		System.out.println(convserToMinutes(B1_1.getTime()-e1_1.getTime()+f1_2.getTime()-e1_2.getTime()+f1_3.getTime()-e1_3.getTime()));
	...
	public void test3(){
		...
		assertEquals(employeeday3.getWorkDur(),convserToMinutes(t1_4.getTime()-t1_3.getTime()-(B1_2.getTime()-A1_2.getTime())));
