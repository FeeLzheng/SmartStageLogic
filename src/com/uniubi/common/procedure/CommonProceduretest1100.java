...
public class CommonProceduretest1100 extends ProcedureBase{
	...
	public void test4(){
		...
		assertEquals(employeeday4.getWorkShow(),1);
		assertEquals(employeeday4.getWorkDur(),0);
		assertEquals(employeeday4.getAllLeaveDur(),convserToMinutes(f1_1.getTime()-A1_3.getTime()+f1_3.getTime()-e1_3.getTime()+f1_2.getTime()-e1_2.getTime()));
