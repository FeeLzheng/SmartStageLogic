...
public class CommonProceduretest169 extends ProcedureBase{
	...
	public void test1(){
		...
		assertEquals(employeeday1.getWorkDur(),convserToMinutes(t1_2.getTime()-t1_1.getTime()-(f1_2.getTime()-e1_2.getTime())));
		assertEquals(employeeday1.getAllLeaveDur(),convserToMinutes(f1_1.getTime()-e1_1.getTime()+f1_2.getTime()-e1_2.getTime()));
	...
	public void test2(){
		...
		assertEquals(employeeday2.getWorkDur(),convserToMinutes(t1_2.getTime()-t1_1.getTime()-(f1_2.getTime()-e1_2.getTime())));
		assertEquals(employeeday2.getAllLeaveDur(),convserToMinutes(f1_1.getTime()-e1_1.getTime()+f1_2.getTime()-e1_2.getTime()));
