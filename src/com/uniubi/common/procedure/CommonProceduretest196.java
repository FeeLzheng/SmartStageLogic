...
public class CommonProceduretest196 extends ProcedureBase{
	...
	public void test1(){
		...
		assertEquals(employeeday1.getLeaveDur(),convserToMinutes(B1_3.getTime()-f1_2.getTime()));
	...
	public void test4(){
		...
		assertEquals(employeeday4.getLeaveDur(),convserToMinutes(B1_3.getTime()-f1_2.getTime()));
