...
public class CommonProceduretest138 extends ProcedureBase{
	...
	public void test1(){
		...
		assertEquals(employeeday1.getLeaveDur(),convserToMinutes(e1_2.getTime()-t1_2.getTime()));
	...
	public void test2(){
		...
		assertEquals(employeeday2.getLeaveDur(),convserToMinutes(e1_2.getTime()-t1_2.getTime()));
