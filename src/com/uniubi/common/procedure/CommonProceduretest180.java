...
public class CommonProceduretest180 extends ProcedureBase{
	...
	public void test1(){
		...
		assertEquals(employeeday1.getAllLeaveDur(),convserToMinutes(f1_1.getTime()-A1_2.getTime()+B1_1.getTime()-e1_1.getTime()));
		assertEquals(employeeday1.getNoShow(),1);
		assertEquals(employeeday1.getOutWork(),1);
		assertEquals(employeeday1.getTpye(),1);
