...
public class CommonProceduretest154 extends ProcedureBase{
	...
	public void test1(){
		...
		assertEquals(employeeday1.getWorkDur(),convserToMinutes(t1_2.getTime()-t1_1.getTime()+t1_4.getTime()-t1_3.getTime()+t1_6.getTime()-t1_5.getTime()-(f1_1.getTime()-A1_3.getTime())));
	...
	public void test4(){
		...
		assertEquals(employeeday4.getWorkDur(),convserToMinutes(t1_6.getTime()-t1_5.getTime()-(f1_1.getTime()-A1_3.getTime())));
