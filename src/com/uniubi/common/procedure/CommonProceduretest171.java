...
public class CommonProceduretest171 extends ProcedureBase{
	...
	public void test1(){
		...
		assertEquals(employeeday1.getDelayDur(),convserToMinutes(t1_1.getTime()-f1_1.getTime()+e1_1.getTime()-A1_1.getTime()));
		assertEquals(employeeday1.getLeaveEarly(),2);
		assertEquals(employeeday1.getLeaveDur(),convserToMinutes(B1_1.getTime()-f1_2.getTime()+e1_2.getTime()-t1_2.getTime()));
	...
	public void test2(){
		...
		assertEquals(employeeday2.getDelayDur(),convserToMinutes(t1_1.getTime()-f1_1.getTime()+e1_1.getTime()-A1_1.getTime()));
		assertEquals(employeeday2.getLeaveEarly(),2);
		assertEquals(employeeday2.getLeaveDur(),convserToMinutes(B1_1.getTime()-f1_2.getTime()+e1_2.getTime()-t1_2.getTime()));
