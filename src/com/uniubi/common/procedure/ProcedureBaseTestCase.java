...
public class ProcedureBaseTestCase extends TestCase {
	 ...
	 static final String moreday="2017-06-12";
	 static final String dayStr1="2017-03-04";
	 static final String dayStr2="2017-03-05";
	 static final String dayStr3="2017-03-06";
//	 static final String dayStr4="2017-03-07";
	...
	static Date A1_n=null;  //多天后的上班时间
	static Date B1_n=null;  //多天后的下班时间
	...
	static Date C1_1 = null;
	 ...
	 static int employeeId2=100000005;
	...
	public ProcedureBaseTestCase(String name){
		...
		try{
			...
			day1=SIMPLE_DATE_FORMAT.parse(dayStr1);
			day2=SIMPLE_DATE_FORMAT.parse(dayStr2);
			day3=SIMPLE_DATE_FORMAT.parse(dayStr3);
			...
			A1_n=COMPLICATED_DATE_FORMAT.parse(moreday+" "+A1Str);
			B1_n=COMPLICATED_DATE_FORMAT.parse(moreday+" "+B2Str);
	...
	public void setUp() throws Exception{
		...
		dao.deleteAttendanceOneDay(dayStr,employeeId2,userId);
		dao.deleteEmployeDayoneDay(employeeId2, userId, dayStr);
		dao.deleteAttendanceOneDay(nextdayStr,employeeId2,userId);
		dao.deleteEmployeDayoneDay(employeeId2, userId, nextdayStr);
	...
	public void Test_execute1() throws Exception{
		...
		try{
			...
			dao.UpdateRule(ruleId1, employeeId2);
				Testx_x_1();
	...
	public void Test_execute2() throws Exception{
		...
		try{
			dao.UpdateRule(ruleId2, employeeId2);
	...
	public Date procedureTime(String time,int No){
		...
		if (No==12){
			e1_1=COMPLICATED_DATE_FORMAT.parse(nextdayStr+" "+time);
			return e1_1;		
		}
		if (No==13){
			f1_1=COMPLICATED_DATE_FORMAT.parse(moreday+" "+time);
			return f1_1;		
		}
		}catch(Exception e){
			e.printStackTrace();			
	...
	public void attendanceCreate(int No){
		...
		if(No==1){
				dao.AttendanceCreate(userId, employeeId2, t1_1, t1_2);
			...
			if(No==1){
				...
				if(No==2){
					if(e1_2!=null||f1_2!=null){
						dao.ProcedureCreate(e1_2, f1_2, procedureid2,employeeId,3);
						}
				}
				if(No==3){
					if(e1_3!=null||f1_3!=null){
						dao.ProcedureCreate(e1_3, f1_3, procedureid3,employeeId,4);
						}
