...
public class CommonProceduretest127 extends ProcedureBase{
	...
	public void test1(){
		...
		assertEquals(employeeday1.getDelayDur(),convserToMinutes(e1_3.getTime()-A1_1.getTime()+e1_2.getTime()-f1_3.getTime()+t1_1.getTime()-f1_2.getTime()));
		...
		assertEquals(employeeday1.getAllLeaveDur(),convserToMinutes(f1_1.getTime()-e1_1.getTime()+f1_2.getTime()-e1_2.getTime()+f1_3.getTime()-e1_3.getTime()));
	...
	public void test2(){
		...
		assertEquals(employeeday2.getDelayDur(),convserToMinutes(e1_3.getTime()-A1_1.getTime()+e1_2.getTime()-f1_3.getTime()+t1_1.getTime()-f1_2.getTime()));
		...
		assertEquals(employeeday2.getAllLeaveDur(),convserToMinutes(f1_1.getTime()-e1_1.getTime()+f1_2.getTime()-e1_2.getTime()+f1_3.getTime()-e1_3.getTime()));
