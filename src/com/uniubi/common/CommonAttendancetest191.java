...
public class CommonAttendancetest191 extends AttendanceBase{
	...
	public void test1(){
		...
		assertEquals(employeeday1.getDelayDur(),convserToMinutes(t1_1.getTime()-A1_1.getTime()+t1_5.getTime()-A1_3.getTime()));
