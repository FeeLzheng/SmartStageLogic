...
//	}
	...
	//测试打卡
		...
		public void test1_177() throws Exception{
			...
			t1_1=COMPLICATED_DATE_FORMAT.parse("2017-03-31"+" "+"09:59:00");
			t1_2=COMPLICATED_DATE_FORMAT.parse("2017-03-31"+" "+"10:11:00");
//			t1_1=null;
//			t1_2=null;
			t1_3=COMPLICATED_DATE_FORMAT.parse("2017-03-31"+" "+"13:31:00");
			t1_4=COMPLICATED_DATE_FORMAT.parse("2017-03-31"+" "+"16:11:00");
			t1_5=COMPLICATED_DATE_FORMAT.parse("2017-03-31"+" "+"20:30:00");
			t1_6=COMPLICATED_DATE_FORMAT.parse("2017-04-01"+" "+"01:11:00");
			caseNo = buildCaseNoFromMethodName(Thread.currentThread().getStackTrace()[1].getMethodName());
			
			
			dao.deleteAttendanceOneDay("2017-04-01", 100000004, 52);
//			dao.deleteAttendanceOneDay("2017-03-31", 100000005, 52);
			dao.deleteAttendanceOneDay("2017-03-31", 100000004, 52);
//			dao.deleteAttendanceOneDay("2017-04-01", 100000005, 52);
			dao.deleteEmployeDayoneDay(100000004, 52, "2017-04-01");
			dao.deleteEmployeDayoneDay(100000004, 52, "2017-03-31");
//			dao.deleteEmployeDayoneDay(100000005, 52, "2017-04-02");
//			dao.deleteEmployeDayoneDay(100000005, 52, "2017-04-01");
...
//			dao.UpdateRule(ruleId3, employeeId);
			...
			attendanceCreate(3);
				...
				CreateRecreationModel createrecreation2 =new CreateRecreationModel();
				createrecreation2.setUserId(userId);
				createrecreation2.setEmployeeId(employeeId2);
				createrecreation2.setStart(createoneday);
				createrecreation2.setEnd(createoneday);
				AttendancelogicMQProducerUtil.sendCreateRecreationMessage(createrecreation2);
...
//		employeeDay1=dao.getEmployeeDay(userId, employeeId2, day, 1);//总记录
//		employeeDay2=dao.getEmployeeDay(userId, employeeId2, day, 2);//分记录
//		
//		AttendanceBase.getInstance(A1_1, A1_2, A1_3, B1_1, B1_2, B1_3, t1_1, t1_2, 
//				t1_3, t1_4,t1_5, t1_6, employeeDay1, employeeDay2, employeeDay3, employeeDay4, caseNo).test(2);
//							
...
//		employeeDay1=dao.getEmployeeDay(userId, employeeId2, day, 1);//总记录
//		employeeDay2=dao.getEmployeeDay(userId, employeeId2, day, 2);//分记录
//		employeeDay3=dao.getEmployeeDay(userId, employeeId2, day, 3);//分记录
//		
//		AttendanceBase.getInstance(A1_1, A1_2, A1_3, B1_1, B1_2, B1_3, t1_1, t1_2, 
//				t1_3, t1_4,t1_5, t1_6, employeeDay1, employeeDay2, employeeDay3, employeeDay4, caseNo).test(3);
//		
...
//		employeeDay2=dao.getEmployeeDay(userId, employeeId2, day, 2);//分记录
//		employeeDay3=dao.getEmployeeDay(userId, employeeId2, day, 3);//分记录
//		employeeDay4=dao.getEmployeeDay(userId, employeeId2, day, 4);//分记录
//		
//		AttendanceBase.getInstance(A1_1, A1_2, A1_3, B1_1, B1_2, B1_3, t1_1, t1_2, 
//				t1_3, t1_4,t1_5, t1_6, employeeDay1, employeeDay2, employeeDay3, employeeDay4, caseNo).test(4);
//		
