...
public class CommonAttendancetest123 extends AttendanceBase{
	...
	public void test1(){
		...
		assertEquals(employeeday1.getLeaveDur(),convserToMinutes(B1_2.getTime()-A1_2.getTime()));
	...
	public void test3(){
		...
		assertEquals(employeeday3.getLeaveDur(),convserToMinutes(B1_2.getTime()-A1_2.getTime()));
