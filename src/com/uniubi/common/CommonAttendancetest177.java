...
public class CommonAttendancetest177 extends AttendanceBase{
	...
	public void test1(){
		...
		assertEquals(employeeday1.getLeaveDur(),convserToMinutes(B1_2.getTime()-t1_3.getTime()));
	...
	public void test3(){
		...
		assertEquals(employeeday3.getLeaveDur(),convserToMinutes(B1_2.getTime()-t1_3.getTime()));
