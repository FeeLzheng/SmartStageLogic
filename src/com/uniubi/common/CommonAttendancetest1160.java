...
public class CommonAttendancetest1160 extends AttendanceBase{
	...
	public void test1(){
		...
		assertEquals(employeeday1.getDelayDur(),convserToMinutes(t1_5.getTime()-A1_3.getTime()+t1_4.getTime()-A1_2.getTime()));
		assertEquals(employeeday1.getLeaveEarly(),2);
		assertEquals(employeeday1.getLeaveDur(),convserToMinutes(B1_1.getTime()-t1_2.getTime()+B1_3.getTime()-t1_6.getTime()+B1_2.getTime()-t1_4.getTime()));
	...
	public void test3(){
		...
		assertEquals(employeeday3.getDelayDur(),convserToMinutes(t1_4.getTime()-A1_2.getTime()));
