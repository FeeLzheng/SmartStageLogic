...
public abstract class AttendanceLogicFlexibleTest1AssertBaseWeekend {
	...
	//第二个请假结束时间
	 ...
	 static AttendanceLogicFlexibleTest1AssertBaseWeekend instance;
	
	public AttendanceLogicFlexibleTest1AssertBaseWeekend(){
		
	}
	
	public static AttendanceLogicFlexibleTest1AssertBaseWeekend getInstance(Date A1,Date B1,Date t1,Date tn,Date e1,Date f1,Date e2,Date f2,EmployeeDay employeeDay,String caseNo){
		try {
			Class<AttendanceLogicFlexibleTest1AssertBaseWeekend> clazz = (Class<AttendanceLogicFlexibleTest1AssertBaseWeekend>) Class.forName("com.uniubi.flexible.oldlogic.weekend.AttendanceLogicFlexibleTest1AssertWeekend"+caseNo);
