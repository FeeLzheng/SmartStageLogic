...
public abstract class AttendanceLogicFlexibleTest2AssertBaseWeekend {
	...
	//工作时长
	 ...
	 static AttendanceLogicFlexibleTest2AssertBaseWeekend instance;
	
	public AttendanceLogicFlexibleTest2AssertBaseWeekend(){
		
	}
	
	public static AttendanceLogicFlexibleTest2AssertBaseWeekend getInstance(Date A1,Date B1,Date A2,Date B2,Date t1_1,Date t1_n,Date t2_1,Date t2_n,Date e1,Date f1,Date e2,Date f2,EmployeeDay employeeDay,EmployeeDay employeeNextDay,String caseNo){
		try {
			Class<AttendanceLogicFlexibleTest2AssertBaseWeekend> clazz = (Class<AttendanceLogicFlexibleTest2AssertBaseWeekend>) Class.forName("com.uniubi.flexible.oldlogic.weekend.AttendanceLogicFlexibleTest2AssertWeekend"+caseNo);
...
//		Testx_x_4_simple_leave();
	...
	public void Testx_x_1_simple_leave(){
		System.out.println(convertMsToMinutes(B1.getTime()-e1.getTime()));
		System.out.println(employeeDay.getAllLeaveDur());
