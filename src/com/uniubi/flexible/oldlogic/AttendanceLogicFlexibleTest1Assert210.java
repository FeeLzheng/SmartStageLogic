...
public class AttendanceLogicFlexibleTest1Assert210 extends
	...
	public void Testx_x_2() {
		...
		assertEquals(employeeDay.getLeaveDur(),convertMsToMinutes(t-tn.getTime()+t1.getTime()+e2.getTime()-f2.getTime()));
		assertEquals(employeeDay.getNoShow(),1);
		assertEquals(employeeDay.getWorkShow(),2);
		assertEquals(employeeDay.getOutWork(),1);
	}
