...
public class AttendanceLogicFlexibleTest1Assert21 extends
		AttendanceLogicFlexibleTest1AssertBase {

	@Override
	public void Testx_x_1() {
		System.out.println("迟到："+convertMsToMinutes(t1.getTime()-f1.getTime()+e1.getTime()-A1.getTime()));
		assertEquals(employeeDay.getWorkDur(),convertMsToMinutes(tn.getTime()-t1.getTime()));
		assertEquals(employeeDay.getDelayDur(),convertMsToMinutes(t1.getTime()-f1.getTime()+e1.getTime()-A1.getTime()));
