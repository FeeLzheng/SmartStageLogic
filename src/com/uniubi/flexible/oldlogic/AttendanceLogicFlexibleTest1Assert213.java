...
public class AttendanceLogicFlexibleTest1Assert213 extends
	...
	public void Testx_x_2() {
		assertEquals(employeeDay.getWorkDur(),0);
		assertEquals(employeeDay.getDelayDur(),convertMsToMinutes(t1.getTime()-A1.getTime()+e1.getTime()-f1.getTime()+e2.getTime()-f2.getTime()));
