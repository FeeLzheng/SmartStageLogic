...
public class AttendanceLogicFlexibleTest1Assert111 extends
	...
	public void Testx_x_1() {
		...
		assertEquals(employeeDay.getLeaveDur(),convertMsToMinutes(e1.getTime()-tn.getTime()+t+t1.getTime()-f1.getTime()));//t-F+E-Tn+T1
